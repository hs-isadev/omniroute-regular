...
for(const platform of ['windows-x64','linux-x64']) {
  ...
  for(const path of ['README.md','docs/antigravity-regular.md','docs/free-provider-expansion.md','docs/testing/antigravity-regular.tdd.md','docs/testing/guided-setup.tdd.md','docs/testing/key-editor.tdd.md','plans/antigravity-regular.md']) await cp(join(root,path),join(bundle,path));
