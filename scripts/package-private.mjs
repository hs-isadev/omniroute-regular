...
for(const [platform,label] of [['windows-x64','Windows'],['linux-x64','Linux']]){
  ...
  await writeFile(join(payload,'dual-provenance.json'),JSON.stringify({version,hosts,status:'private-family-package',personalDataIncluded:false,browserSessionsIncluded:false,publishable:false,sourceBaseline:'OmniRoute 0.6.0 private package with one shared local browser consumer profile',notice:'Each recipient signs in with their own accounts. No CAPTCHA or anti-bot bypass is implemented.'},null,2)+'\n');
