...
const release=resolve(import.meta.dirname,'../release/OmniRoute-Private-0.6.2-private.1');
...
console.log(archive);console.log(`SHA256 ${digest}`);console.log('Shareable archive created. Verify the adjacent SHA-256 file before distribution.');
