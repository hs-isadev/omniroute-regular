...
You are the Antigravity host, using the model actually selected and available in Antigravity; do not assume it can run Sol or Astra. Codex separately prefers Sol for everyday orchestration, Astra for complex coordination and Terra for bounded execution.
